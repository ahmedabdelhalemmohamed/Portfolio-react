    ...
    <div className="grid grid-cols-1 p-10 sm:grid-cols-2 justify-items-center text-center">
      <div className="flex flex-col justify-center items-center space-y-5 order-2 sm:order-1">
        <div className="space-y-2">
          <h1 className="text-xl font-bold lg:text-3xl">I'm Ahmed Abdelhalem Mohamed</h1>
          <h3 className="text-xs lg:text-2xl">Frontend Developer (React)</h3>
          <p className="text-xs lg:text-2xl">I build responsive and modern web applications.</p>
        </div>
      ...
      <div className="order-1 sm:order-2">
        <img src="/person.png" height={200} width={200} className="sm:rounded-full sm:ml-auto rounded-4xl lg:rounded-2xl lg:w-sm"/>
      </div>
    </div>
  );
};
